                   ...
                   <form class="pull-left" action="{{url('searchTardiness')}}" method="post">
                       {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input <?php if(@$search == "tardiness"){echo("checked");}?> name='tardines' value="tardiness" type="radio"   >Tardiness
                            <input <?php if(@$search == "absence"){echo("checked");}?> name='tardines' value="absence" type="radio"  > Absence
                            <input <?php if(@$search == "leave"){echo("checked");}?> name='tardines' value="leave" type="radio"  > Leave
